...
<article class="h-entry h-review page page--template-${ this.data.template }" id="main" itemscope itemtype="http://schema.org/Review">
  <header class="page__header">
    <h1 class="page__title p-name" itemprop="name headline">${movie["Name"]}</h1>
    <p>
  ...
  <div class="e-content page__content" id="content" itemprop="reviewBody">
    <p>About this ${movie["Type"]} on other sites: <a href="https://www.themoviedb.org/${movie["Type"]}/${movie["TMDb ID"]}" target="_blank" rel="noopener nofollow">TMDB</a>, <a href="https://www.imdb.com/title/${movie["IMDb ID"]}" target="_blank" rel="noopener nofollow">IMDB</a></p>
  </div>
  <footer class="page__footer">
    <p><a href="/lists/${movie["Type"]}/">← Back to list of ${movie["Type"]}</a></p>
